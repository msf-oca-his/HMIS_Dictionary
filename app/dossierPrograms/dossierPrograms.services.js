...
var qryProgramStageSections = dhisUrl + 'programStages/:programStageId.json?fields=displayName,programStageSections[id,displayName,dataElements['
    + encodeURIComponent(":all") + '[options[displayName]]]],dataElements['
    + encodeURIComponent(":all") + '[options[displayName]]&paging=false';
